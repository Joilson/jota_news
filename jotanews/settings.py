"""
Django settings for jotanews project.
...
SECRET_KEY = 'django-insecure-rlfn1mgepk1q^p_(*=dg2^f7wnu*lf1r!7rrjh08#i6_qf-f=x'
...
WSGI_APPLICATION = 'jotanews.wsgi.application'
